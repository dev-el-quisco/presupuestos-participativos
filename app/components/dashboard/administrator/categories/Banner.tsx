...
const Banner = ({ onCategoryCreated, searchTerm, onSearchChange }: BannerProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(data.error || "Error al crear tipo de proyecto");
      }
    } catch (error) {
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
        <div className="relative w-full md:w-auto">
          ...
          <input
            ...
            placeholder="Buscar tipos de proyectos..."
          />
        </div>
        <button
          type="button"
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
                  <p className="text-sm text-blue-800">
                    <strong>Nota:</strong> Este tipo de proyecto estará disponible para asignar a nuevos proyectos.
                  </p>
                </div>
                ...
                <div className="mt-6 flex justify-end gap-3">
                  ...
                  <button
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? "Creando..." : "Crear Tipo de Proyecto"}
                  </button>
                </div>
              </form>
            </div>

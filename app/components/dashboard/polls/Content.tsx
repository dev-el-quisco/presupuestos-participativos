...
//   const [showVotanteModal, setShowVotanteModal] = useState(false);
...
//   const handleRegistrarVotos = (mesa) => {
//     setSelectedMesa(mesa);
//     setShowVotosModal(true);
//   };

//   const handleRegistrarVotante = (mesa) => {
//     setSelectedMesa(mesa);
//     setShowVotanteModal(true);
//   };

//   const handleCambiarEstado = (mesa) => {

      ...
      {message ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between space-x-2 sm:space-x-4">
            ...
            <button
              type="submit"
              className="flex-1 py-2 px-2 sm:px-4 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-[#2c3e4a] hover:bg-[#31c46c] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#31c46c]"
            >
              Enviar
            </button>
          </div>
